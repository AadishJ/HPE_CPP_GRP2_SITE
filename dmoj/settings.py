...
# Fixed: Set to empty string instead of None to avoid TypeError
...
if DMOJ_PDF_PDFOID_URL:
    ...
    assert DMOJ_PDF_PROBLEM_CACHE == "" or os.path.isdir(DMOJ_PDF_PROBLEM_CACHE)
    # If using X-Accel-Redirect, the cache directory must be configured
    assert DMOJ_PDF_PROBLEM_INTERNAL is None or DMOJ_PDF_PROBLEM_CACHE != ""
